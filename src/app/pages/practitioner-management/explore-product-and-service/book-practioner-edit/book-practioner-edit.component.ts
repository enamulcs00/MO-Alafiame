...
@Component({
  selector: 'app-book-practioner-edit',
  templateUrl: './book-practioner-edit.component.html',
  styleUrls: ['./book-practioner-edit.component.css']
})
export class BookPractionerEditComponent implements OnInit {
  ...
  this.SetBannerItemInEditForm()
    ...
    EditBanner(){
      let url = 'admin/editHomeScreenBookPractitioner'
